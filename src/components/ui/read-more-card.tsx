    ...
    return (
        <div className="bg-white border border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-300 mb-6 overflow-hidden not-prose">
            <div className="p-6 md:p-8">
                ...
                {isOpen && (
                    <div className="mt-6 pt-6 border-t border-slate-100 prose prose-slate prose-lg max-w-none prose-headings:font-heading prose-headings:text-primary prose-h4:text-xl prose-h4:mt-6 prose-h4:mb-3 prose-h4:text-slate-700 prose-p:text-slate-600 prose-p:leading-loose prose-li:text-slate-600 prose-li:marker:text-secondary prose-li:leading-relaxed prose-strong:text-slate-900 animate-in fade-in duration-300">
                        {children}
                    </div>
                )}
